...
titles <- tribble(
  ...
  1, "", "health", NA, "doctoral-students/anujan-poologaindran",
  2, "", "economic", "policy", "enrichment-students/daniele-guariso",
  3, "", "health", "policy", "enrichment-students/akira-endo",
  ...
  8, "", NA, "policy", "doctoral-students/keri-grieman",
  9, "", "engineer", NA, "enrichment-students/lizhi-zhang",
  10, "Exploration and Exploitation in US Corporate Research", "economic", NA, "doctoral-students/nikolas-kuhlen",
  11, "", "social", NA, "enrichment-students/obi-thompson-sargoni",
  ...
  14, "", "engineer", "policy", "enrichment-students/risa-ueno",
